export const settingsZhCN = {
  settings: {
    ...
    agentDescriptions: {
      'default-1': '主讲分析师，清晰有条理地分析商业数据',
      'default-2': '数据支持，提供专业数据解读',
      'default-3': '行业专家，提供战略视角和市场洞察',
    },
    close: '关闭',
    save: '保存',
    // Provider settings
...
export const settingsEnUS = {
  settings: {
    ...
    required: 'Required',
    agentNames: {
      'default-1': 'Lead Analyst',
      'default-2': 'Data Specialist',
      'default-3': 'Industry Consultant',
    },
    agentRoles: {
    ...
    agentDescriptions: {
      'default-1': 'Lead analyst with clear and structured business analysis',
      'default-2': 'Provides data evidence and technical expertise',
      'default-3': 'Industry expert offering strategic insights',
    },
    close: 'Close',
    save: 'Save',
    // Provider settings

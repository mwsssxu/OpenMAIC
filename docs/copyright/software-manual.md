...
5. **近期课程区域**：标题"近期课程"右侧有"全部"链接，下方展示3张正在学习的课程卡片，每张包含课程图标（emoji）、课程名称、类别标签和进度信息。

6. **推荐课程区域**：标题"推荐课程"右侧有"更多"链接，下方水平滚动展示4张推荐课程卡片：机器学习概论（人工智能）、商业数据分析（商业分析）、写作与表达（人文素养）、科学思维方法（思维方式）。

7. **我的笔记区域**：标题"我的笔记"右侧有"全部"链接，下方4个分类卡片展示笔记统计：全部笔记（32条）、收藏（12条）、今日（3条）、快速记录入口。

8. **底部Tab导航栏**：固定5个导航按钮：首页（🏠图标）、课程（📚图标）、创建新课程（➕图标）、笔记（📝图标）、我的（👤图标），当前选中"首页"。

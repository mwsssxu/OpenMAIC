...
function RootStack() {
  ...
  return (
    <Stack screenOptions={{ headerShown: false }}>
      ...
      <Stack.Screen name="wallet" options={{ headerShown: true, title: t('home.wallet') }} />
      <Stack.Screen name="enterprise" options={{ headerShown: true, title: t('home.enterpriseServices') }} />
      <Stack.Screen name="shared-notes" options={{ headerShown: true, title: t('home.sharedNotes') }} />
    </Stack>
  );
}

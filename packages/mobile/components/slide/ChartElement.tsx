...
function BarChartView({ element, scaleX, scaleY, labels, series, colors, isWhiteboard }: {
  ...
  const containerStyle = useMemo(() => {
    return {
      ...
      minHeight: element.height > 0 ? element.height * scaleY : 160,
      backgroundColor: '#fff',
      borderRadius: 6,
      padding: 8,
      zIndex: 1,
...
function SimpleBarChart({ element, scaleX, scaleY, items, colors, isWhiteboard }: {
  ...
  const containerStyle = useMemo(() => {
    return {
      ...
      top: element.top * scaleY,
      width: Math.max(element.width * scaleX, 60),
      minHeight: element.height > 0 ? element.height * scaleY : 100,
      backgroundColor: '#fff',
      borderRadius: 6,
      padding: 8,
      zIndex: 1,
...
function PieChartView({ element, scaleX, scaleY, labels, series, colors, isWhiteboard }: {
  ...
  const containerStyle = useMemo(() => {
    return {
      ...
      top: element.top * scaleY,
      width: Math.max(element.width * scaleX, 60),
      minHeight: element.height > 0 ? element.height * scaleY : 140,
      backgroundColor: '#fff',
      borderRadius: 6,
      padding: 8,
      zIndex: 1,
...
function FallbackChart({ element, scaleX, scaleY, isWhiteboard }: { element: PPTChartElement; scaleX: number; scaleY: number; isWhiteboard: boolean }) {
  const containerStyle = useMemo(() => {
    return {
      ...
      top: element.top * scaleY,
      width: Math.max(element.width * scaleX, 60),
      minHeight: element.height > 0 ? element.height * scaleY : 80,
      backgroundColor: '#fff',
      borderRadius: 6,
      padding: 8,

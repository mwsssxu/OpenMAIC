...
**HARD LIMIT: At most 1 interactive scene per course** — choose the SINGLE most impactful and visually engaging concept for the interactive widget. Use slides for all other concepts, even if they could benefit from interaction.

1. **Opening scenes (slides)**: Introduction, learning objectives, context setting
2. **Middle scene (1 interactive widget)**: The most impactful hands-on exploration
3. **Transition scenes (slides)**: Concept explanations, step-by-step walkthroughs
4. **Closing scenes (slides)**: Summary, key takeaways, next steps

## Widget Type Selection

Choose the best widget type for the SINGLE interactive scene:
...
**Choose the widget type that best serves the most important concept in the course.**
...
4. **Interactive limit**: At most 1 interactive scene per course. Choose the most impactful concept.
5. **Widget selection**: Pick the best widget type for the single interactive scene.
6. **Flow**: Slides should introduce concepts; the single widget should let students explore the most important concept.
